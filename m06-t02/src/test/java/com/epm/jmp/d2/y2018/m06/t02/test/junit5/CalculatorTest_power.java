...
public class CalculatorTest_power {
    ...
    public void testPower_NonAssociativity() {
        ...
        int n = 7;
        int m = 11;
        assertNotEquals(calc.power(calc.power(a, n), m), calc.power(a, calc.power(n, m)));
    }
    ...
    public void testPower_NonCommutativity() {
        int n = 7;
        int m = 11;
        assertNotEquals(calc.power(n, m), calc.power(m, n));
    }
    ...
    public void testPower_ZeroRaisedToPower() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            calc.power(a, n);
        }, "Zero cannot be raised to the power");
    }
