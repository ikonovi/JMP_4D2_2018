package com.epm.jmp.d2.y2018.m09.t01.model.horse.breed.impl;

import com.epm.jmp.d2.y2018.m09.t01.model.horse.breed.Breed;

public class RockyMountainHorseBreed implements Breed {

    private String regestedName;
    private HorseBreedType breedType;
    private boolean isColored;

    public RockyMountainHorseBreed(String regestedName) {
        super();
        this.regestedName = regestedName;
    }

    public RockyMountainHorseBreed(String regestedName, HorseBreedType breedType, boolean isColored) {
        super();
        this.regestedName = regestedName;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RockyMountainHorseBreed other = (RockyMountainHorseBreed) obj;
    ...
    public String toString() {
        return "RockyMountainHorseBreed [regestedName=" + regestedName + ", breedType=" + breedType
                + ", isColored=" + isColored + "]";
    }
