...
public class MustangHorseBreed implements Breed {

    private String regestedName;
    private HorseBreedType breedType;
    private boolean isColored;

    public MustangHorseBreed(String regestedName) {
        super();
        this.regestedName = regestedName;
    }

    public MustangHorseBreed(String regestedName, HorseBreedType breedType, boolean isColored) {
        super();
        this.regestedName = regestedName;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MustangHorseBreed other = (MustangHorseBreed) obj;
    ...
    public String toString() {
        return "MustangHorseBreed [regestedName=" + regestedName + ", breedType=" + breedType
                + ", isColored=" + isColored + "]";
    }
