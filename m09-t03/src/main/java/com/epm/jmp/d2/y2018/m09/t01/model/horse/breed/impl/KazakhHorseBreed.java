...
public class KazakhHorseBreed implements Breed {
    ...
    public KazakhHorseBreed(String regestedName) {
        super();
        this.regestedName = regestedName;
    }

    public KazakhHorseBreed(String regestedName, HorseBreedType breedType, boolean isColored) {
        super();
        this.regestedName = regestedName;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        KazakhHorseBreed other = (KazakhHorseBreed) obj;
    ...
    public String toString() {
        return "KazakhHorseBreed [regestedName=" + regestedName + ", breedType=" + breedType
                + ", isColored=" + isColored + "]";
    }
